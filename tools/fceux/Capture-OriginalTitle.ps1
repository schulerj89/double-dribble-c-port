...
$captureRoot = Join-Path $projectRoot 'captures\original'
...
Write-Host "Capturing original frames through frame $FinalFrame..."
...
Write-Host "Captured $($screenshots.Count) reference screenshots in $captureRoot"
