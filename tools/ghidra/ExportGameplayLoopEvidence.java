...
public class ExportGameplayLoopEvidence extends GhidraScript {
    private static final long[] BANK0_ANCHORS = {
        ...
        0x9102L, 0x914EL, 0x91A6L, 0x92BDL, 0x9395L, 0x93AEL, 0x9400L, 0x9413L, 0x9418L,
        0x9431L, 0x9490L, 0x9583L, 0x9645L,
        0x98B5L, 0xA0DAL, 0xA129L, 0xA29DL, 0xA347L, 0xA44BL, 0xA61FL, 0xA68AL, 0xA6C3L,
        0xA85AL, 0x993AL, 0x9B42L, 0x9E70L, 0x9FA3L, 0xAA20L, 0xAAEEL,
    ...
    private static final long[] FIXED_ANCHORS = {
        0xC41CL, 0xC477L, 0xC694L, 0xC6ADL, 0xCC94L, 0xCD24L, 0xCD5CL, 0xCD64L,
